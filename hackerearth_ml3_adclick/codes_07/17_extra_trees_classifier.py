...
model_name = 'et_20170813_1800' # [85,93,105,109,25,108,81,77,29,37]
model_name = 'et_20170813_1830' # [i for i in range(130)]
print (model_name)
...
for param_list in param_space:
    ...
    for train_indices, test_indices in kf.split(X):
        ...
        clf = ExtraTreesClassifier(max_depth=param_list[param_to_int_dict['max_depth']], 
